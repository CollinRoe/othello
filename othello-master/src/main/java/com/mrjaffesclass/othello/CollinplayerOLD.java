 ...
 * Test player
 */
public class CollinplayerOLD extends Player {
   ...
   */
  public CollinplayerOLD(int color) {  
    super(color);
  ...
  public Position getBestMove(Board board, ArrayList<Position> legalMoves) {
    Position bestMove = legalMoves.get(0);
      ...
      //Prefer Edges
      for (int i=0; i<legalMoves.size(); i++)  {             
          if (isCornerAdjacent(legalMoves.get(i)) == false && isEdge(legalMoves.get(i))){
              return legalMoves.get(i);
          }
      }
      ...
      for (int i=0; i<legalMoves.size(); i++)  {             
          if (isCornerAdjacent(legalMoves.get(i)) == false){
              return legalMoves.get(i);
          }
   ...
   */
  public boolean isCornerAdjacent(Position move) {
    //TOP LEFT
    ...
    if (move.getCol() == 0  &&  move.getRow() == 2) {     
        return true;
    }
    if (move.getCol() == 1  &&  move.getRow() == 1) {     
        return true;
    }
    if (move.getCol() == 2  &&  move.getRow() == 0) {     
        return true;
    }
    ...
    if (move.getCol() == 7  &&  move.getRow() == 2) {     
        return true;
    }
    if (move.getCol() == 6  &&  move.getRow() == 1) {     
        return true;
    }
    if (move.getCol() == 5  &&  move.getRow() == 0) {     
        return true;
    }
    ...
    if (move.getCol() == 7  &&  move.getRow() == 5) {     
        return true;
    }
    if (move.getCol() == 6  &&  move.getRow() == 6) {     
        return true;
    }
    if (move.getCol() == 5  &&  move.getRow() == 7) {     
        return true;
    }
